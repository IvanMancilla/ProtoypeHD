...
<div class="col bgWhite " align="center">
    <br>
    <h1>Usted ya ha iniciado sesión</h1>
    <br>
</div>
@else	
...
<option value="ZW">Zimbabue</option>
    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <input type="text" value="{{old('CP')}}" onkeypress="return checkNumero(event)" name="CP" class="form-control">
        </div>
    </div>  
    
    <hr>
    <div align="right">
    <button type="submit" role="button" class="btn bgGold">Registrarse</button>
    </div>
